...
function () {
  var _ref = _asyncToGenerator(
  /*#__PURE__*/
  _regenerator().m(function _callee(email) {
    var res, _t;
    ...
    return _regenerator().w(function (_context) {
      while (1) switch (_context.p = _context.n) {
        ...
        case 1:
          ...
          if (res.data.status === 'success') {
            (0, _alert.showAlert)('success', 'Send Reset password token to your email');
            window.setTimeout(function () {
              location.assign('/');
            }, 1500);
          }
...
function () {
  var _ref2 = _asyncToGenerator(
  /*#__PURE__*/
  _regenerator().m(function _callee2(password, passwordConfirm, token) {
    var res, _t2;
...
var stripePromise = (0, _stripeJs.loadStripe)('pk_test_51RnkMQ81XNBuuiIcb5KAlJhkTnkTO6s5yt04WQribftV3IxDClkJRW3XxPATI5BMkpcULuktwSmcXnApkQvKzD2F00ifgqOSEF');
...
function () {
  ...
  _regenerator().m(function _callee(tourId) {
    var stripe, session, _ref3, error, _t;
...
var resetPasswordFrom = document.querySelector('.resetPasswordForm');
...
if (userPasswordForm) {
  ...
  function () {
    var _ref = _asyncToGenerator(
    /*#__PURE__*/
    _regenerator().m(function _callee(el) {
...
if (resetPasswordFrom) {
  resetPasswordFrom.addEventListener('submit', function (e) {
    e.preventDefault();
    var password = document.getElementById('password').value;
    var passwordConfirm = document.getElementById('confirm-password').value;
